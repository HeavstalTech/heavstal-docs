...
:::caution[Important]
This API will be deprecated as of **Tuesday, September 1st, 2026** and will no longer function, please migrate to the maintained Heavstal AI API to prevent damage whrb this service stops.
:::
...
<Endpoint method="POST" url="/api/v1/jeden" />
