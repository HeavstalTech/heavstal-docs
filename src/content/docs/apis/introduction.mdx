...
> **Note:** You can create up to 5 API Keys.
...
> **Note:** If your whitelist has already reached its limit of 5 entries, you will be unable to whitelist newly blocked entities until you remove an existing one.
</details>
...
> **Note:** This invalidates your current key immediately. Any applications using it will stop working until you update them with the new key.
</details>
...
> **Note:** This deletes your key. You will lose access to all APIs until you generate a new one.
</details>
