...
export default function FeedbackWidget() {
  ...
  // future API call based on user interaction
    if (submitted) return;
    setSubmitted(true);
            ...
            {!submitted ? (
              <>
                ...
                <button 
                  ...
                  className="group flex items-center gap-2.5 px-6 py-2.5 bg-white dark:bg-slate-800 border border-gray-200 dark:border-gray-700 rounded-full hover:border-red-500 hover:text-red-600 dark:hover:border-red-400 dark:hover:text-red-400 text-gray-600 dark:text-gray-300 font-medium transition-all shadow-sm hover:shadow"
              ...
              <div className="flex items-center gap-2 px-6 py-2.5 text-blue-600 dark:text-blue-400 font-medium transition-opacity">
