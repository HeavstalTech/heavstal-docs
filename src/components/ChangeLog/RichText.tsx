...
export default function RichText({ text, className = '' }: { text: string, className?: string }) {
  ...
  return (
    <div 
      className={`prose prose-invert max-w-none text-[var(--sl-color-gray-2)] text-[15px] leading-relaxed [&>p]:m-0 [&>p]:mb-3 [&>h1]:text-2xl [&>h2]:text-xl [&>h3]:text-lg [&>h1]:font-bold [&>h2]:font-bold [&>h3]:font-bold [&>h1]:mb-2 [&>h2]:mb-2 [&>h3]:mb-2 ${className}`}
